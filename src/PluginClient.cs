...
public sealed class PluginClient : IAsyncDisposable
{
    ...
    public async Task ConnectAsync(CancellationToken cancellationToken = default)
    {
        ...
        await SendAsync("plugin.hello", new { pluginId = _pluginId, token = _token, protocolMajor = 1, protocolMinor = 0, manifestSha256 = hash, declaredCapabilities = _capabilities, processId = Environment.ProcessId }, cancellationToken);
